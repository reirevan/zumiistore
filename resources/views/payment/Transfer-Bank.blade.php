    ...
    <div class="max-w-4xl w-full p-4">
            ...
            <div class="mb-6">
                ...
                <div class="mt-3 space-y-2">
                    ...
                    <div class="flex justify-between items-center mt-3">
                        ...
                        <button class="bg-gray-300 text-gray-700 px-4 py-1 rounded">Belum Bayar</button>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
            ...
            <div class="text-center">
                <p class="font-bold text-xl">MOHON TUNGGU</p>
            </div>
        </div>
...
<script>
    ...
    // ------------------------------
    // EVENT: Ketika Halaman Sudah Dimuat (DOMContentLoaded)
    // ------------------------------
    document.addEventListener("DOMContentLoaded", function () {
        ...
        // ------------------------------
        // Membuat Kode Unik 3 Digit (100-999) dan Menambahkan ke Harga
        // ------------------------------
        let uniqueCode = Math.floor(100 + Math.random() * 900);

        // Membersihkan format harga yang tidak perlu
        let price = orderData.price.replace(/\.?00$/, "").replace(/\D/g, "");
        let finalAmount = parseInt(price) + uniqueCode;

        // Menampilkan metode pembayaran dan total harga baru
        ...
        // Simpan kembali jumlah pembayaran final untuk validasi saat pembayaran
        localStorage.setItem("finalPaymentAmount", finalAmount);

        // Hapus paymentDeadline lama dari localStorage jika ada, agar countdown baru dimulai
        localStorage.removeItem("paymentDeadline");

        // Simpan waktu deadline yang baru
        let deadline = Date.now() + 3 * 60 * 60 * 1000; // 3 jam dalam milidetik
        localStorage.setItem("paymentDeadline", deadline);

        // Jalankan countdown pembayaran
        startPaymentTimer(); // Panggil fungsi untuk menjalankan countdown berdasarkan waktu deadline
    });
</script>
