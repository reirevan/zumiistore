        ...
        <div class="max-w-6xl mx-auto w-full px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <main class="flex-1 space-y-6">
                    <section aria-labelledby="account-info-title" class="bg-[#1E2037] rounded-xl p-6 text-white max-w-3xl w-full">
                     <h2 class="text-lg font-normal mb-4" id="account-info-title">
                      Informasi Akun
                     </h2>
                     <form class="space-y-4">
                      <div>
                       <label class="block text-sm font-semibold mb-1 text-white" for="username">
                        Atur Username
                       </label>
                       <div class="relative">
                        <input class="w-full rounded-md bg-gray-300 text-xs text-black px-3 py-2 pr-8" id="username" type="text" value="Revan Permana"/>
                        <button aria-label="Clear username" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-900" type="button">
                      ...
                      <div>
                       <label class="block text-sm font-semibold mb-1 text-white" for="email">
                        Email
                       </label>
                       <div class="relative">
                        <input class="w-full rounded-md bg-gray-300 text-xs text-black px-3 py-2 pr-8" id="email" type="email" value="reyrevan123@gmail.com"/>
                        <button aria-label="Clear email" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-900" type="button">
                         <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 18L18 6M6 6l12 12" stroke-linecap="round" stroke-linejoin="round">
                          </path>
                         </svg>
                      ...
                      <div>
                       <label class="block text-sm font-semibold mb-1 text-white" for="phone">
                        Nomor Telepon
                       </label>
                       <div class="relative">
                        <input class="w-full rounded-md bg-gray-300 text-xs text-black px-3 py-2 pr-8" id="phone" type="text" value="087804135926"/>
                        <button aria-label="Clear phone number" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-900" type="button">
                         <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M6 18L18 6M6 6l12 12" stroke-linecap="round" stroke-linejoin="round">
                          </path>
                         </svg>
                      ...
                      <button class="bg-yellow-400 text-black font-semibold text-sm rounded-md px-4 py-2 flex items-center space-x-2 hover:brightness-110 transition" type="submit">
                       <span>
                        Simpan
                       </span>
                    ...
                    <section aria-labelledby="change-password-title" class="bg-[#1E2037] rounded-xl p-6 text-white max-w-3xl w-full">
                     <h2 class="text-lg font-normal mb-4" id="change-password-title">
                      Ubah Password
                     </h2>
                     <form class="space-y-4">
                      <div>
                       <label class="block text-sm font-semibold mb-1 text-white" for="old-password">
                        Password Lama
                       </label>
                       <div class="relative">
                        <input class="w-full rounded-md bg-gray-300 text-xs text-black px-3 py-2 pr-8" id="old-password" placeholder="Masukan Password Lama" type="password"/>
                        <button aria-label="Toggle old password visibility" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-900" type="button">
                         <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <div>
                       <label class="block text-sm font-semibold mb-1 text-white" for="new-password">
                        Password Baru
                       </label>
                       <div class="relative">
                        <input class="w-full rounded-md bg-gray-300 text-xs text-black px-3 py-2 pr-8" id="new-password" placeholder="Masukan Password Baru" type="password"/>
                        <button aria-label="Toggle new password visibility" class="absolute right-2 top-1/2 -translate-y-1/2 text-gray-600 hover:text-gray-900" type="button">
                         <svg class="h-4 w-4" fill="none" stroke="currentColor" stroke-width="2" viewbox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                          <path d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" stroke-linecap="round" stroke-linejoin="round">
                          </path>
                          <path d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" stroke-linecap="round" stroke-linejoin="round">
