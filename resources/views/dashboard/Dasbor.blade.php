    ...
    <main class="w-full max-w-screen-xl mx-auto px-4 py-8">
        <div class="max-w-6xl mx-auto w-full px-4">
            ...
            <div class="flex flex-col lg:flex-row gap-8">
                ...
                <!-- Main content -->
                <section class="bg-[#1f2233] rounded-xl flex-1 p-6 text-white flex flex-col gap-6">
                    <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                        <div class="border border-[#5a5f7a] rounded-md px-4 py-2 text-[14px] flex items-center gap-2">
                            <span>Saldo Kamu:</span>
                            <i class="fas fa-credit-card"></i>
                            <span class="font-semibold">Rp{{ number_format(Auth::user()->balance ?? 0, 0, ',', '.') }}</span>
                        </div>
                        <button class="bg-red-600 hover:bg-red-700 rounded-md px-4 py-2 text-[14px] font-semibold" type="button">
                            Deposit <span class="text-xl font-bold">+</span>
                        </button>
                    </div>
    
                    <div>
                        <p class="text-[14px] mb-3">Pesananku</p>
                        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full">
                            <div class="bg-[#f5f5f7] text-black rounded-md h-16 flex flex-col justify-center items-center">
                                <span class="font-bold text-lg leading-none">10</span>
                                <span class="text-[10px]">Seluruh Pesanan</span>
                            </div>
                            <div class="bg-[#f5f5f7] text-black rounded-md h-16 flex flex-col justify-center items-center">
                                <span class="font-bold text-lg leading-none">3</span>
                                <span class="text-[10px]">Dalam Proses</span>
                            </div>
                            <div class="bg-[#f5f5f7] text-black rounded-md h-16 flex flex-col justify-center items-center">
                                <span class="font-bold text-lg leading-none">6</span>
                                <span class="text-[10px]">Berhasil</span>
                            </div>
                            <div class="bg-[#f5f5f7] text-black rounded-md h-16 flex flex-col justify-center items-center">
                                <span class="font-bold text-lg leading-none">1</span>
                                <span class="text-[10px]">Kadaluarsa</span>
                            </div>
                        </div>
                    </div>
    
                    <div class="flex justify-between items-center text-[14px] mt-6">
                        <p>Pesanan Terbaru</p>
                        <p class="text-yellow-400 cursor-pointer hover:underline">Lihat Semua Pesanan</p>
                    </div>
    
                    <!-- Scrollable table on mobile -->
                    <div class="overflow-x-auto">
                        <table class="w-full text-[13px] border-separate border-spacing-y-2 min-w-[600px]">
                            <thead class="text-left text-white/80 font-semibold border-b border-white/20">
                                <tr>
                                    <th class="pl-4 py-2 w-[40%]">Produk</th>
                                    <th class="py-2 w-[20%] text-center">User ID</th>
                                    <th class="py-2 w-[20%] text-right pr-4">Harga</th>
                                    <th class="py-2 w-[20%] text-center">Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr class="bg-white rounded-md shadow-sm">
                                    <td class="flex items-center gap-3 pl-4 py-3 text-black rounded-l-md w-[40%]">
                                        <img src="https://storage.googleapis.com/a1aa/image/550ab87f-87b8-4266-f203-e970cbef1470.jpg" alt="Weekly Diamond Pass" class="w-10 h-10 rounded" />
                                        <div class="leading-tight">
                                            <p class="font-semibold text-[14px]">Mobile Legends</p>
                                            <p class="text-[10px]">Weekly Diamond Pass</p>
                                        </div>
                                    </td>
                                    <td class="text-center text-[12px] text-black/70">112233</td>
                                    <td class="font-bold text-black text-right pr-4">Rp 28.000,-</td>
                                    <td class="pr-4 text-center">
                                        <span class="bg-green-600 text-white text-[12px] rounded px-3 py-1 inline-block">Sukses</span>
                                    </td>
                                </tr>
                                <tr class="bg-white rounded-md shadow-sm">
                                    <td class="flex items-center gap-3 pl-4 py-3 text-black rounded-l-md w-[40%]">
                                        <img src="https://placehold.co/40x40/png?text=ML" alt="100 Diamonds" class="w-10 h-10 rounded" />
                                        <div class="leading-tight">
                                            <p class="font-semibold text-[14px]">Mobile Legends</p>
                                            <p class="text-[10px]">100 Diamonds</p>
                                        </div>
                                    </td>
                                    <td class="text-center text-[12px] text-black/70">112233</td>
                                    <td class="font-bold text-black text-right pr-4">Rp 50.000,-</td>
                                    <td class="pr-4 text-center">
                                        <span class="bg-red-600 text-white text-[12px] rounded px-3 py-1 inline-block">Gagal</span>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
