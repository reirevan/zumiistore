                ...
                <main class="flex-1">
                    <div class="flex justify-between items-center mb-4">
                      <h2 class="text-black font-semibold text-lg">
                        Level Keanggotaan Saat ini:
                      </h2>
                      <button
                        type="button"
                        class="bg-red-600 hover:bg-red-700 text-white font-semibold text-sm rounded-md px-4 py-2 flex items-center gap-1"
                      >
                        Tingkatkan Level <span class="text-xl font-bold">+</span>
                      </button>
                    </div>
            
                    <section
                      class="gold-gradient rounded-md h-16 flex items-center justify-center mb-6"
                      aria-label="Current membership level"
                    >
                      <h3 class="text-black font-bold text-2xl">GOLD</h3>
                    </section>
            
                    <div>
                      <p class="text-black font-semibold mb-3">Lihat Semua Level</p>
                      <ul class="space-y-4">
                          ...
                          <div class="flex items-center gap-4">
                            ...
                            <div>
                              ...
                              <p class="text-xs text-gray-700">
                                mendapatkan akses Harga lebih murah dari harga Pasar
                              </p>
                            </div>
                          </div>
                          <div
